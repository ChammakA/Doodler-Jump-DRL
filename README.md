...
* **Persona Comparisons:** Heatmaps of `(x, y)` positions
...
python src/train_doodler.py --algo ppo --reward_persona survivor
python src/train_doodler.py --algo ppo --reward_persona aggressive
python src/train_doodler.py --algo dqn --reward_persona survivor

# Evaluate all trained models
python src/eval_doodler.py --algo ppo --model_path models/doodler/ppo_survivor_final.zip
...
Short Clips of Models and Human Gameplay
